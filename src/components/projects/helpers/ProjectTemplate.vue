<template>
    <v-card :color="cardColor">
        ...
        <InfoHeader :iconColor="iconColor" :textColor="headerTextColor"
            :leftIcon="leftIcon" :leftText="leftText"
        ...
        <v-card-actions class="mt-n3">
            ...
            <v-spacer/>
            <v-btn small rounded v-show="hasLink" color="primaryWhite" text target="_blank" :href="link">
