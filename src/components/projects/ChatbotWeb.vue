  ...
  <v-card dark color="tertiary">
    ...
    <v-card-text>
      <div class="text-primaryLight">
        ...
        place l'architecture REST en back-end et également faire le lien avec l'API Discord.
      </div>
    </v-card-text>
    <v-card-actions class="mt-n3">
      <v-chip draggable small class="text-tertiary my-1 ml-2" color="warning">Node.JS</v-chip>
    </v-card-actions>
  </v-card>
</template>
