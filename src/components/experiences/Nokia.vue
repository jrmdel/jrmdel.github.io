  ...
  >
    <template v-slot:content>
      <div>
        ...
        Lannion. Le but de ma mission était de développer une preuve de concept d'une solution web
        sous la forme d'un dashboard de vulnérabilités pour venir répondre à des besoins axés
        cybersécurité.
      </div>
    </template>
    <template v-slot:extra>
      ...
      <ul class="ml-4 mt-1">
        ...
        <li>
          Mise en place d'un contrôle d'accès souple reprenant les concepts de RBAC et de ABAC.
        </li>
        <li>Démonstration de notre solution à des collègues basé.e.s aux Etats-Unis.</li>
        <li>
          Proposition d'architecture permettant l'ajout de nouvelles fonctionnalités sous forme de
          micro-services.
        </li>
      </ul>
    </template>
